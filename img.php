<?php
	...
	{
		throw Exception($hotel_icon . ' Not Found.');exit(0);
	}
	...
	$target_width = isset($_GET['w']) ? intval($_GET['w']) : 100;
	$target_height = isset($_GET['h']) ? intval($_GET['h']) : 100;
	...
	switch($FileType){
		...
		break;
		default:
			echo "ERROR:image type error ". $hotel_icon;exit(0);
		break;
	}
