...
switch($action)
{
	...
	case "save":
		...
		$HotelCityObj->setVar('city_parentid', (isset($_POST['city_parentid'])) ? intval($_POST['city_parentid']) : 0);
		$HotelCityObj->setVar('city_name', (isset($_POST['city_name'])) ? addslashes($_POST['city_name']) : 0);
